...
<div class="container-fluid">
    <div class="container-fluid form-neon">
                ...
                <table class="table table-dark table-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" >
                            ...
                            <td>
                                <form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" data-form="loans" autocomplete="off">
                        ...
                        <?php 
                                    ...
                                    $_SESSION['prestamo_items'] += $items['Cantidad'];
                                }
                        ?>

                        <tr class="text-center bg-light">
                            <td><strong>TOTAL</strong></td>
                            <td><strong><?php echo $_SESSION['prestamo_items'] ?> items</strong></td>
                            <td colspan="2"></td>
        ...
        <form class="FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" data-form="save" autocomplete="off">
            <fieldset>
...
<div class="modal fade" id="ModalAgregarItem" tabindex="-1" role="dialog" aria-labelledby="ModalAgregarItem" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content FormularioAjax" method="POST" action="<?php echo SERVERURL; ?>ajax/prestamoAjax.php" data-form="default" autocomplete="off">
            <div class="modal-header">
