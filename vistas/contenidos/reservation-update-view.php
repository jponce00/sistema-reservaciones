                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" class="form-control" name="prestamo_observacion_up" id="prestamo_observacion" maxlength="400" value="<?php echo $campos["prestamo_observacion"]; ?>">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-responsive" >
                        <table class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr class="text-center">
                                    <td colspan="2">No hay pagos resgitrados.</td>                                    
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
