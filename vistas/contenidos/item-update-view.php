                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="num" pattern="[0-9]{1,9}" class="form-control" name="item_stock_up" id="item_stock" maxlength="9" value="<?php echo $campos["item_stock"]; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="item_estado_up" id="item_estado">
                                ...
                                <option value="Deshabilitado" <?php if ($campos["item_estado"] == "Deshabilitado") {echo 'selected=""';} ?> >Deshabilitado</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="item_detalle_up" id="item_detalle" maxlength="190" value="<?php echo $campos["item_detalle"]; ?>">
                        </div>
                    </div>
                </div>
            </div>
